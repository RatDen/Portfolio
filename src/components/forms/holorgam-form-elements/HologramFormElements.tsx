...
import { darken, cssVar, lighten } from 'polished';
...
export const FormInput = styled.input`
	...
	padding: 10px 20px;
	background-color: ${() =>
		darken(0.15, cssVar('--main-theme-color') as string)};
	border: 2px solid var(--main-theme-color);
	border-radius: 5px;
	color: ${() => lighten(0.15, cssVar('--main-theme-color') as string)};
	font: inherit;
	z-index: 1;
	...
	&:-webkit-autofill {
		...
		-webkit-box-shadow: 0 0 0px 1000px
			${() => darken(0.15, cssVar('--main-theme-color') as string)} inset;
	}
...
export const FormFieldErrorText = styled.p<{ children: string }>`
